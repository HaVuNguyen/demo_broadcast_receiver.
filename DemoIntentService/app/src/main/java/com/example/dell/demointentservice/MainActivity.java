package com.example.dell.demointentservice;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.startButton = (ImageButton) this.findViewById(R.id.button_start);
        this.stopButton = (ImageButton) this.findViewById(R.id.button_stop);
